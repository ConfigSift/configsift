import { RedactionOptions, RedactedValue } from "./types";
...
function basicMask(value: string, opts: Required<RedactionOptions>): RedactedValue {
...
function redactUrl(value: string, opts: Required<RedactionOptions>): RedactedValue {
  try {
...
export function redactValue(value: string, opts: RedactionOptions = {}): RedactedValue {
